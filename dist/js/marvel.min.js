...
this.Marvel.Templates.character = function(obj) {
    ...
    with (obj) __p += '<h1>Character View</h1>\n<span class="test" href="search/beast">search for beast</span>\n' + (null == (__t = name) ? "" : __t) + '!\n<img style="width: 480px;" src="' + (null == (__t = thumbnail.path) ? "" : __t) + "." + (null == (__t = thumbnail.extension) ? "" : __t) + '" alt="This is a small picture of the Marvel character ' + (null == (__t = name) ? "" : __t) + '" />';
    return __p;
    ...
    with (obj) __p += '<h1 class="thatthing" style="font-size: 3em;">Search View</h1>\n<label for="search">Starts with ...</label>\n<input type="text" name="search" />';
    return __p;
}, this.Marvel.Templates.test = function(obj) {
    obj || (obj = {});
    {
        var __t, __p = "";
        _.escape;
    ...
    render: function() {
        ...
        this.childViews.push(searchInput), this.$el.append(this.template()), this.collection.each(function(model) {
            var characterView = new Marvel.View.Character({
                model: model
            });
            this.$el.append(characterView.render().el), this.childViews.push(characterView);
        }, this), this.$el.append(searchInput.render().el);
    },
    ...
    events: {
        "click .test": function(evt) {
            evt.preventDefault(), this.updateHistory(evt);
        }
    },
    initialize: function() {},
    updateHistory: function(evt) {
        evt.preventDefault();
        var $el = $(evt.target), url = $el.attr("href");
        "undefined" == typeof url || url.match(/\/\//) || url.match(/mailto/gi) || marvel.router.navigate(url, {
            trigger: !0
        });
    },
    render: function() {
    ...
    return _.extend({
        ...
        showView: function(view) {
            this.currentView && this.currentView.close(), this.currentView = view, this.currentView.render(), 
