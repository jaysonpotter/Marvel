/*! Marvel Project - v0.0.1 - 2015-02-16*/
...
this.Marvel.Templates.character = function(obj) {
    ...
    updateHistory: function(evt) {
        evt.preventDefault(), console.log("test");
        var $el = $(evt.target), url = $el.attr("href");
        console.log("this should have triggered a change in route"), "undefined" == typeof url || url.match(/\/\//) || url.match(/mailto/gi) || marvel.router.navigate(url, {
            trigger: !0
        });
    },
    render: function() {
