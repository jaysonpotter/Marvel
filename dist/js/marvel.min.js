...
this.Marvel.Templates.character = function(obj) {
    ...
    render: function() {
        ...
        this.$el.append(this.template()), this.$el.append(searchInput.render().el), 0 === this.collection.length ? this.collection.fetchCharactersSearchResults({
            name: this.name
        }) : this.collection.each(function(model) {
            var characterView = new Marvel.View.Character({
                model: model
            ...
            this.$el.append(characterView.render().el), this.childViews.push(characterView);
        }, this), this.childViews.push(searchInput);
    },
