/*! Marvel Project - v0.0.1 - 2015-02-01*/
...
this.Marvel.Templates.index = function(obj) {
    ...
    with (obj) __p += "<h1>Marvel at the Data</h1>\nMy Favorite Marvel character is " + (null == (__t = name) ? "" : __t) + '!\n<img src="' + (null == (__t = thumbnail.path) ? "" : __t) + "." + (null == (__t = thumbnail.extension) ? "" : __t) + '" alt="This is a small picture of the Marvel character ' + (null == (__t = name) ? "" : __t) + '" />';
    return __p;
