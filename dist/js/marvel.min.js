/*! Marvel Project - v0.0.1 - 2015-02-03*/
    ...
    index: function() {
        if ("index" !== this._current) {
            var indexPageView = new Marvel.View.Index({
                model: marvel.content.example
            });
            indexPageView.render(), this._current = "index";
        }
    },
    search: function() {
        if ("search" !== this._current) {
            new Marvel.View.Search({});
        }
    }
    ...
    return _.extend({
        ...
        doSomethingBeforeReady: function() {
            ...
            $.getJSON(url, {}).done(function(res) {
                marvel.content.example = new Marvel.Model.Character(res.data.results[0]), that.ready();
