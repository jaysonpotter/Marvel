/*! Marvel Project - v0.0.1 - 2015-02-18*/
...
Marvel.Router = Marvel.Router || {}, Marvel.View = Marvel.View || {}, Marvel.Templates = Marvel.Templates || {}, 
Marvel.Utils = Marvel.Utils || {}, this.Marvel = this.Marvel || {}, this.Marvel.Templates = this.Marvel.Templates || {}, 
this.Marvel.Templates.character = function(obj) {
    obj || (obj = {});
    {
        var __t, __p = "";
        _.escape;
    }
    with (obj) __p += "<h2>" + (null == (__t = name) ? "" : __t) + '</h2>\n<img style="width: 320px;" src="' + (null == (__t = thumbnail.path) ? "" : __t) + "." + (null == (__t = thumbnail.extension) ? "" : __t) + '" alt="This is a small picture of the Marvel character ' + (null == (__t = name) ? "" : __t) + '" />';
    return __p;
    ...
    with (obj) __p += "<h1>Index View</h1>\nMy Favorite Marvel character is " + (null == (__t = name) ? "" : __t) + '!\n<img style="width: 100%;" src="' + (null == (__t = thumbnail.path) ? "" : __t) + "." + (null == (__t = thumbnail.extension) ? "" : __t) + '" alt="This is a small picture of the Marvel character ' + (null == (__t = name) ? "" : __t) + '" />';
    return __p;
}, this.Marvel.Templates.loader = function(obj) {
    obj || (obj = {});
    {
        var __p = "";
        _.escape;
    }
    with (obj) __p += '<div id="loading">\n    <div class="sphere s-center"></div>\n    <div class="sphere s-5"></div>\n    <div class="sphere s-4"></div>\n    <div class="sphere s-3"></div>\n    <div class="sphere s-2"></div>\n    <div class="sphere s-1"></div>\n</div>';
    return __p;
}, this.Marvel.Templates.search = function(obj) {
    obj || (obj = {});
    {
        var __p = "";
        _.escape;
    }
    with (obj) __p += "<h1>Search Parent View</h1>";
    return __p;
}, this.Marvel.Templates.search_input = function(obj) {
    obj || (obj = {});
    {
        var __p = "";
        _.escape;
    }
    with (obj) __p += '<h1>Search View</h1>\n<form id="SearchStartsWith" action="search">\n    <label for="SearchInput">Starts with ...</label>\n    <input type="search" id="SearchInput" name="search" placeholder="Enter Search" />\n    <input type="submit" value="Submit">\n</form>';
    return __p;
    ...
    initialize: function() {
        this.childViews = [], this.listenTo(this.collection, "add", this.renderAdditionalCharacters);
    },
    render: function() {
        this.collection.each(function(model) {
            var characterView = new Marvel.View.Character({
                model: model
            });
            this.$el.append(characterView.render().el), this.childViews.push(characterView);
        }, this);
    },
    ...
    initialize: function(options) {
        this.childViews = [], this.listenTo(this.collection, "add", this.renderAdditionalCharacters), 
        this.name = options.name, 0 === this.collection.length && this.collection.fetchCharactersSearchResults({
            name: this.name
        });
    },
    ...
    render: function() {
        ...
        this.childViews.push(searchInput), this.$el.append(this.template()), this.$el.append(searchInput.render().el), 
    ...
    renderAdditionalCharacters: function(newModel) {
        ...
        this.$el.append(characterView.render().el), console.log("rendered a search result, but should not have"), 
    ...
    events: {
        "submit #SearchStartsWith": function(evt) {
            evt.preventDefault(), this.routeToResults(evt);
        }
    },
    initialize: function() {},
    routeToResults: function(evt) {
        var searchQuery = $(evt.target).find("#SearchInput").val(), queryURL = "/search/" + searchQuery;
        marvel.router.navigate(queryURL, {
            trigger: !0
        });
    },
    render: function() {
    ...
    this.remove(), this.unbind(), this.onClose && this.onClose(), this.childViews && _.each(this.childViews, function(childView) {
        childView.close();
    });
}, Backbone.View.prototype.transitionIn = function(callback) {
    $("#Content").addClass("is-visible"), $("#Content").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function() {
        _.isFunction(callback) && callback();
    });
}, Backbone.View.prototype.transitionOut = function(callback) {
    $("#Content").removeClass("is-visible"), $("#Content").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function() {
        _.isFunction(callback) && callback();
    });
    ...
    index: function() {
        if ("index" !== this._current) {
            var indexPageView = new Marvel.View.Index({
                collection: marvel.content.example
            });
            marvel.showView(indexPageView), this._current = "index";
        }
    },
    search: function(name) {
        var nameSearchResultsView, searchQuery = "search_" + name;
        this._current !== searchQuery && (marvel.content[searchQuery] || (marvel.content[searchQuery] = new Marvel.Collection.Characters()), 
        nameSearchResultsView = new Marvel.View.Search({
            collection: marvel.content[searchQuery],
            name: name || "gambit"
        }), marvel.showView(nameSearchResultsView), this._current = searchQuery);
    }
    ...
    return _.extend({
        ...
        fetchDataBeforeReady: function() {
            var url = "http://gateway.marvel.com:80/v1/public/characters/1009313?apikey=bea22e84deda871e47704c00d29cb43e", that = this;
        ...
        showView: function(view) {
            var previousView = this.currentView || null, nextView = view, self = this;
            previousView ? previousView.transitionOut(function() {
                previousView.close(), nextView.render(), $("#Content").append(nextView.$el), nextView.transitionIn(), 
                self.currentView = nextView;
            }) : (nextView.render(), $("#Content").append(nextView.$el), nextView.transitionIn(), 
