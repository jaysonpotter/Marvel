/*! Marvel Project - v0.0.1 - 2015-02-17*/
...
this.Marvel.Templates.character = function(obj) {
    ...
    renderAdditionalCharacters: function() {
        var characterView = new Marvel.View.Character({
            model: model
        });
        this.$el.append(characterView.render().el), this.childViews.push(characterView);
    ...
    search: function(name) {
        ...
        if (this._current !== searchTerm) {
            ...
            marvel.content[resultsName] || (marvel.content[resultsName] = new Marvel.Collection.Characters());
            var nameSearchResultsView = new Marvel.View.Search({
                collection: marvel.content[resultsName],
                name: name
            });
            marvel.showView(nameSearchResultsView), this._current = searchTerm;
        }
    }
