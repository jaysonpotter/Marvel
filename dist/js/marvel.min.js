/*! Marvel Project - v0.0.1 - 2015-01-31*/
!function(global, factory) {
    ...
    } else root.Marionette = factory(root, root.Backbone, root._);
}(this, function(root, Backbone, _) {
    "use strict";
    ...
    var previousMarionette = root.Marionette, Marionette = Backbone.Marionette = {};
    Marionette.VERSION = "2.1.0", Marionette.noConflict = function() {
        return root.Marionette = previousMarionette, this;
    ...
    return Marionette.extend = Backbone.Model.extend, Marionette.getOption = function(target, optionName) {
        if (target && optionName) {
            var value;
            return value = target.options && void 0 !== target.options[optionName] ? target.options[optionName] : target[optionName];
        }
    }, Marionette.proxyGetOption = function(optionName) {
        return Marionette.getOption(this, optionName);
    }, Marionette.normalizeMethods = function(hash) {
        var normalizedHash = {};
        return _.each(hash, function(method, name) {
            _.isFunction(method) || (method = this[method]), method && (normalizedHash[name] = method);
        }, this), normalizedHash;
        ...
        var splitter = /(^|:)(\w)/gi, triggerMethod = function(event) {
            var result, methodName = "on" + event.replace(splitter, getEventName), method = this[methodName];
            return _.isFunction(method) && (result = method.apply(this, _.tail(arguments))), 
            _.isFunction(this.trigger) && this.trigger.apply(this, arguments), result;
        };
        ...
        destroy: function() {
            var args = slice.call(arguments);
            return this.triggerMethod.apply(this, [ "before:destroy" ].concat(args)), this.triggerMethod.apply(this, [ "destroy" ].concat(args)), 
            this.stopListening(), this.off(), this;
        },
        triggerMethod: Marionette.triggerMethod,
        getOption: Marionette.proxyGetOption
    }), Marionette.Object = function(options) {
        this.options = _.extend({}, _.result(this, "options"), options), this.initialize(this.options);
    }, Marionette.Object.extend = Marionette.extend, _.extend(Marionette.Object.prototype, {
        initialize: function() {},
        destroy: function() {
    ...
    }), _.extend(Marionette.Object.prototype, Backbone.Events), Marionette.Region = function(options) {
        if (this.options = options || {}, this.el = this.getOption("el"), this.el = this.el instanceof Backbone.$ ? this.el[0] : this.el, 
        this.el || throwError('An "el" must be specified for a region.', "NoElError"), this.$el = this.getEl(this.el), 
        this.initialize) {
        ...
        buildRegion: function(regionConfig, DefaultRegionClass) {
            return _.isString(regionConfig) ? this._buildRegionFromSelector(regionConfig, DefaultRegionClass) : regionConfig.selector || regionConfig.el || regionConfig.regionClass ? this._buildRegionFromObject(regionConfig, DefaultRegionClass) : _.isFunction(regionConfig) ? this._buildRegionFromRegionClass(regionConfig) : void throwError("Improper region configuration type. Please refer to http://marionettejs.com/docs/marionette.region.html#region-configuration-types");
        },
        ...
        _buildRegionFromObject: function(regionConfig, DefaultRegionClass) {
            ...
            return regionConfig.parentEl && (region.getEl = function(el) {
                if (_.isObject(el)) return Backbone.$(el);
                var parentEl = regionConfig.parentEl;
                return _.isFunction(parentEl) && (parentEl = parentEl()), parentEl.find(el);
            }), region;
        },
        ...
        show: function(view, options) {
            this._ensureElement();
            var showOptions = options || {}, isDifferentView = view !== this.currentView, preventDestroy = !!showOptions.preventDestroy, forceShow = !!showOptions.forceShow, isChangingView = !!this.currentView, _shouldDestroyView = !preventDestroy && isDifferentView;
            _shouldDestroyView && this.empty();
            var _shouldShowView = isDifferentView || forceShow;
            return _shouldShowView ? (view.once("destroy", _.bind(this.empty, this)), view.render(), 
            isChangingView && this.triggerMethod("before:swap", view), this.triggerMethod("before:show", view), 
            _.isFunction(view.triggerMethod) ? view.triggerMethod("before:show") : this.triggerMethod.call(view, "before:show"), 
            this.attachHtml(view), this.currentView = view, isChangingView && this.triggerMethod("swap", view), 
            this.triggerMethod("show", view), _.isFunction(view.triggerMethod) ? view.triggerMethod("show") : this.triggerMethod.call(view, "show"), 
            this) : this;
        },
        _ensureElement: function() {
            _.isObject(this.el) || (this.$el = this.getEl(this.el), this.el = this.$el[0]), 
            this.$el && 0 !== this.$el.length || throwError('An "el" ' + this.$el.selector + " must exist in DOM");
        },
        getEl: function(el) {
            return Backbone.$(el);
        },
        attachHtml: function(view) {
            this.el.innerHTML = "", this.el.appendChild(view.el);
        },
        empty: function() {
            var view = this.currentView;
            if (view) return this.triggerMethod("before:empty", view), this._destroyView(), 
            this.triggerMethod("empty", view), delete this.currentView, this;
        },
        ...
        var RegionManager = Marionette.Controller.extend({
            constructor: function(options) {
                this._regions = {}, Marionette.Controller.call(this, options);
            },
            addRegions: function(regionDefinitions, defaults) {
                _.isFunction(regionDefinitions) && (regionDefinitions = regionDefinitions.apply(this, arguments));
                var regions = {};
            ...
            addRegion: function(name, definition) {
                ...
                this.triggerMethod("before:add:region", name, region), this._store(name, region), 
            ...
            emptyRegions: function() {
                var regions = this.getRegions();
                return _.each(regions, function(region) {
                    region.empty();
                }, this), regions;
            },
            destroy: function() {
            ...
            _remove: function(name, region) {
                ...
                delete this._regions[name], this._setLength(), this.triggerMethod("remove:region", name, region);
            },
            _setLength: function() {
        ...
        render: function(template, data) {
            template || throwError("Cannot render the template since its false, null or undefined.", "TemplateNotFoundError");
            var templateFunc;
        ...
        constructor: function(options) {
            ...
            Backbone.View.apply(this, arguments), Marionette.MonitorDOMRefresh(this), this.listenTo(this, "show", this.onShowCalled);
        },
        ...
        delegateEvents: function(events) {
            ...
            this.bindEntityEvents(this.collection, this.getOption("collectionEvents")), this;
        },
        ...
        undelegateEvents: function() {
            var args = slice.call(arguments);
            return Backbone.View.prototype.undelegateEvents.apply(this, args), this.unbindEntityEvents(this.model, this.getOption("modelEvents")), 
            this.unbindEntityEvents(this.collection, this.getOption("collectionEvents")), this;
        },
        onShowCalled: function() {},
        _ensureViewIsIntact: function() {
            if (this.isDestroyed) {
                var err = new Error("Cannot use a view thats already been destroyed.");
                throw err.name = "ViewDestroyedError", err;
            }
        },
        destroy: function() {
            if (!this.isDestroyed) {
        ...
        serializeData: function() {
            var data = {};
            return this.model ? data = _.partial(this.serializeModel, this.model).apply(this, arguments) : this.collection && (data = {
        ...
        render: function() {
            ...
            this.bindUIElements(), this.triggerMethod("render", this), this;
        },
        _renderTemplate: function() {
            var template = this.getTemplate();
            if (template !== !1) {
                template || throwError("Cannot render the template since it is null or undefined.", "UndefinedTemplateError");
        ...
        destroy: function() {
            return this.isDestroyed ? void 0 : Marionette.View.prototype.destroy.apply(this, arguments);
        }
    }), Marionette.CollectionView = Marionette.View.extend({
        childViewEventPrefix: "childview",
        constructor: function(options) {
            var initOptions = options || {};
            this.sort = _.isUndefined(initOptions.sort) ? !0 : initOptions.sort, this._initChildViewStorage(), 
            Marionette.View.apply(this, arguments), this._initialEvents(), this.initRenderBuffer();
        },
        ...
        endBuffering: function() {
            this.isBuffering = !1, this._triggerBeforeShowBufferedChildren(), this.attachBuffer(this, this.elBuffer), 
            this._triggerShowBufferedChildren(), this.initRenderBuffer();
        },
        _triggerBeforeShowBufferedChildren: function() {
            this._isShown && _.invoke(this._bufferedChildren, "triggerMethod", "before:show");
        },
        _triggerShowBufferedChildren: function() {
            this._isShown && (_.each(this._bufferedChildren, function(child) {
                _.isFunction(child.triggerMethod) ? child.triggerMethod("show") : Marionette.triggerMethod.call(child, "show");
        ...
        _onCollectionAdd: function(child) {
            ...
            var ChildView = this.getChildView(child), index = this.collection.indexOf(child);
        ...
        addEmptyView: function(child, EmptyView) {
            ...
            _.isFunction(emptyViewOptions) && (emptyViewOptions = emptyViewOptions.call(this));
            var view = this.buildChildView(child, EmptyView, emptyViewOptions);
            this._isShown && this.triggerMethod.call(view, "before:show"), this.children.add(view), 
            this.renderChildView(view, -1), this._isShown && this.triggerMethod.call(view, "show");
        },
        getChildView: function() {
            var childView = this.getOption("childView");
            return childView || throwError('A "childView" must be specified', "NoChildViewError"), 
            childView;
        },
        addChild: function(child, ChildView, index) {
            var childViewOptions = this.getOption("childViewOptions");
            _.isFunction(childViewOptions) && (childViewOptions = childViewOptions.call(this, child, index));
            var view = this.buildChildView(child, ChildView, childViewOptions);
            return this._updateIndices(view, !0, index), this._addChildView(view, index), view;
        },
        _updateIndices: function(view, increment, index) {
            this.sort && (increment ? (view._index = index, this.children.each(function(laterView) {
                laterView._index >= view._index && laterView._index++;
            })) : this.children.each(function(laterView) {
                laterView._index >= view._index && laterView._index--;
            }));
        },
        _addChildView: function(view, index) {
            this.proxyChildEvents(view), this.triggerMethod("before:add:child", view), this.children.add(view), 
            this.renderChildView(view, index), this._isShown && !this.isBuffering && (_.isFunction(view.triggerMethod) ? view.triggerMethod("show") : Marionette.triggerMethod.call(view, "show")), 
        ...
        removeChildView: function(view) {
            ...
            this.stopListening(view), this.children.remove(view), this.triggerMethod("remove:child", view), 
        ...
        attachHtml: function(collectionView, childView, index) {
            collectionView.isBuffering ? (collectionView.elBuffer.appendChild(childView.el), 
            collectionView._bufferedChildren.push(childView)) : collectionView._insertBefore(childView, index) || collectionView._insertAfter(childView);
        },
        ...
        destroy: function() {
            return this.isDestroyed ? void 0 : (this.triggerMethod("before:destroy:collection"), 
        ...
        proxyChildEvents: function(view) {
            ...
            this.listenTo(view, "all", function() {
                var args = slice.call(arguments), rootEvent = args[0], childEvents = this.normalizeMethods(_.result(this, "childEvents"));
        ...
        render: function() {
            return this._ensureViewIsIntact(), this.isRendered = !0, this.resetChildViewContainer(), 
        ...
        getChildViewContainer: function(containerView) {
            ...
            if (childViewContainer) {
                ...
                container.length <= 0 && throwError('The specified "childViewContainer" was not found: ' + containerView.childViewContainer, "ChildViewContainerMissingError");
        ...
        destroy: function() {
            return this.isDestroyed ? this : (this.regionManager.destroy(), Marionette.ItemView.prototype.destroy.apply(this, arguments));
        },
        addRegion: function(name, definition) {
        ...
        removeRegion: function(name) {
            return this.triggerMethod("before:region:remove", name), delete this.regions[name], 
        ...
        _initializeRegions: function(options) {
            ...
            _.isFunction(regionOptions) && (regionOptions = regionOptions.call(this, options)), 
            _.extend(regions, regionOptions), this.addRegions(regions);
        },
        _reInitializeRegions: function() {
            this.regionManager.emptyRegions(), this.regionManager.each(function(region) {
                region.reset();
            });
        },
        ...
        _initRegionManager: function() {
            this.regionManager = this.getRegionManager(), this.listenTo(this.regionManager, "before:add:region", function(name) {
        ...
        var methods = {
            setElement: function(setElement, behaviors) {
                return setElement.apply(this, _.tail(arguments, 2)), _.each(behaviors, function(b) {
                    b.$el = this.$el, b.el = this.el;
                }, this), this;
            },
            destroy: function(destroy, behaviors) {
                var args = _.tail(arguments, 2);
                return destroy.apply(this, args), _.invoke(behaviors, "destroy", args), this;
            },
            ...
            delegateEvents: function(delegateEvents, behaviors) {
                var args = _.tail(arguments, 2);
                return delegateEvents.apply(this, args), _.each(behaviors, function(b) {
            ...
            undelegateEvents: function(undelegateEvents, behaviors) {
                var args = _.tail(arguments, 2);
                return undelegateEvents.apply(this, args), _.each(behaviors, function(b) {
            ...
            behaviorEvents: function(behaviorEvents, behaviors) {
                ...
                return _.each(behaviors, function(b, i) {
                    var _events = {}, behaviorEvents = _.clone(_.result(b, "events")) || {}, behaviorUI = _.result(b, "ui"), ui = _.extend({}, viewUI, behaviorUI);
        ...
        constructor: function(options) {
            Backbone.Router.apply(this, arguments), this.options = options || {};
        ...
        this.submodules = {}, _.extend(this, options), this._initChannel();
        ...
        _initRegionManager: function() {
            this._regionManager = this.getRegionManager(), this.listenTo(this._regionManager, "before:add:region", function(name) {
                this.triggerMethod("before:add:region", name);
        ...
        this.app = app, this.startWithParent = !0, _.isFunction(this.initialize) && this.initialize(moduleName, app, this.options);
...
var Marvel = Marvel || {}, marvel = marvel || {};

Marvel.App || (Marvel.App = {}), Marvel.Model || (Marvel.Model = {}), Marvel.Collection || (Marvel.Collection = {}), 
Marvel.Router || (Marvel.Router = {}), Marvel.View || (Marvel.View = {}), Marvel.Templates || (Marvel.View = {}), 
Marvel.Utils || (Marvel.Utils = {}), Marvel.Model.Character = Backbone.Model.extend({
    initialize: function() {
    ...
    index: function() {
        if ("index" !== this._current) {
            ...
            indexPageView.render(), this._current = "index", $("#Content").show();
        }
    }
    ...
    return _.extend({
        ...
        content: {},
        initialize: function() {
            this.docRoot = document.location.href, this.docOrigin = document.location.origin, 
        ...
        doSomethingBeforeReady: function() {
            var setOfTen = "http://gateway.marvel.com:80/v1/public/characters/1009313/comics?limit=10&apikey=bea22e84deda871e47704c00d29cb43e", that = this;
            $.getJSON(setOfTen, {}).done(function(res) {
                console.log("the Marvel Response", res), marvel.content = new Marvel.Model.Character(res.data), 
                marvel.test = new Marvel.Collection.Characters(res.data.results), that.ready();
            }).fail(function(res, status) {
                console.log(res, status);
            });
        }
    });
}, this.Marvel = this.Marvel || {}, this.Marvel.Templates = this.Marvel.Templates || {}, 
this.Marvel.Templates.index = function(obj) {
    obj || (obj = {});
    {
        var __t, __p = "";
        _.escape;
    }
    with (obj) __p += "<h1>yay, still have to test data coming in though. And generate an index wrapper." + (null == (__t = test) ? "" : __t) + "</h1>";
    return __p;
}, $(document).ready(function() {
    marvel = new Marvel.App.Mvl(), marvel.initialize(), window.onpopstate = function(event) {
